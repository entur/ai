...
Ensure Cloud SQL `max_connections` (minus 3 reserved) handles worst-case HPA pod count. See [Terraform modules](../platform/terraform-modules.md) for Cloud SQL sizing.
